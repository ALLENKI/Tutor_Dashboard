...
<div class="modal-content">
	...
	<div class="modal-body">
		<div class="alert alert-success">
			Hey! You are eligible to teach this class. 
		</div>

		<div class="alert alert-danger no-border" id="validation_errors" style="display:none;">
		</div>

		{!! BootForm::open()->action(route('teacher::invitations.accept',[$invitation->id])) !!}

		<div class="text-right">
			<button type="submit" class="btn btn-primary">Confirm Acceptance <i class="icon-arrow-right14 position-right"></i></button>
		</div>
