<?php $topic = $newInvite->ahamClass->topic; ?>
<?php $class = $newInvite->ahamClass; ?>
<div class="panel panel-flat">
				...
				<ul class="media-list content-group">
					<li class="media stack-media-on-mobile">
    					...
    					<div class="media-body">
							<h6 class="media-heading"><a href="{{ route('student::courses.show',$topic->slug) }}">{{ $topic->name }}</a></h6>
	...
	<div class="panel-footer">
		<div class="heading-elements">
			<a href="#" class="btn btn-xs btn-danger pull-left" data-url="{{ route('teacher::invitations.decline_modal', [$newInvite->id]) }}" onclick='openAjaxModal(this);'>Decline</a>

			<a href="#" class="btn btn-xs btn-success pull-right" data-url="{{ route('teacher::invitations.accept_modal', [$newInvite->id]) }}" onclick='openAjaxModal(this);'>Accept <i class="icon-arrow-right14 position-right"></i></a>
		</div>
	</div>
