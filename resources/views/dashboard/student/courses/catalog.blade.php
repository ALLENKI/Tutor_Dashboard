				...
				<div class="sidebar-category">
					<div class="category-content no-padding">
						<ul class="nav navigation">
							...
							<a href="{{ route('student::courses.catalog',['subject' => $subject->slug]) }}" class="legitRipple"> {{ $subject->name }} 
							...
							<a href="{{ route('student::courses.catalog',['subject' => $subCategory->parent->slug, 'sub-category' => $subCategory->slug]) }}" class="legitRipple"> {{ $subCategory->name }} 
	...
	<div class="col-md-9">
		<div class="row">
			@foreach($topics as $index => $topic)
				...
				<div class="col-md-6">
					@include('dashboard.student.snippets._free_class')
				</div>
