...
<div class="row">
	<div class="col-md-8">
		...
		<div class="panel panel-flat" id="upcoming-classes">
		    ...
		    @if($classes->count())
			    @foreach($classes as $class)
			    	@include('dashboard.student.snippets._horizontal_class')
			    @endforeach
		    @else
			    ...
			    <a href="#" class="btn btn-danger btn-mini-xs" data-url="{{ route('student::courses.request', $topic->id ) }}" onclick='openAjaxModal(this);'>Request a Class</i></a>
			    </div>
		    @endif
		</div>
