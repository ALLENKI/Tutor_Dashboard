<div class="panel panel-white">
	...
	<div class="panel-body" style="display: block;min-height: 195px;">
		...
		<span class="label label-primary pull-right">OPEN FOR ENROLLMENT</span>
...
+					@endif
		...
		<span class="label label-primary pull-right" style="border-color:#f88506;background-color:#f88506;"><a href="{{ route('student::courses.show',$topic->slug) }}" style="color:#fff;">REQUEST FOR CLASS</a></span>
	...
	<div class="panel-footer">
		<div class="heading-elements">
			<a href="{{ route('student::courses.show',$topic->slug) }}" class="btn btn-xs btn-success pull-right">Go To Course Page <i class="icon-arrow-right14 position-right"></i></a>
		</div>
	</div>
