	...
	<div class="page-header-content">
		<div class="page-title">
			...
			<ul class="breadcrumb breadcrumb-caret position-right">
				...
				<li class="active">Guest Series</li>
			</ul>
		</div>

		<div class="heading-elements">
			<div class="heading-btn-group">
                <a href="{{ route('admin::classes_mgmt::guest_series.create') }}" class="btn btn-link btn-float has-text"><i class="icon-calendar text-primary"></i><span>Create New Guest Series</span></a>
			</div>
		</div>
	</div>
</div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">List of Series</h5>
		<div class="heading-elements">
			<ul class="icons-list">
	...
	<div class="panel-body">
		This Table Shows all the Guest Series. 
	</div>
...
$(document).ready(function(){
    ...
    table =  $('#myTable').DataTable({
		...
		"columns": [
		    { "data": "guest_series.code", "name": "code" },
		    { "data": "guest_series.name", "name": "name" },
		    { "data": "guest_series.location_id", "name": "location_id" },
            { "data": "guest_series.levels", "name": "levels", "sortable": false },
		    { "data": "guest_series.episodes", "name": "episodes", "sortable": false },
		    { "data": "guest_series.enrollment_restriction", "name": "enrollment_restriction" },
		    { "data": "guest_series.created_at", "name": "created_at"},
		    { "data": "guest_series.actions", "name": "actions", "sortable": false, "className": 'text-center'},
		],
    });
