<div class="modal-content">
	...
	<div class="modal-body">
		<div class="alert alert-success">
			You are about to cancel enrollment of {{ $student->user->name }}
		</div>

		<div class="checkbox">
			<label>
				<input type="checkbox" id="confirm_again" class="styled">
				Sure I want to cancel enrollment.
			</label>
		</div>
		...
		{!! 
			BootForm::open()
					->action(route('admin::classes_mgmt::enrollment.cancel',[$class->id,$student->id])) 
