	...
	<div class="page-header-content">
		<div class="page-title">
			...
			<ul class="breadcrumb breadcrumb-caret position-right">
				...
				<li class="active">Create New Repeat Class</li>
			</ul>
		</div>
	</div>
</div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Create a New Repeat Class</h5>
	</div>
	...
	<div class="panel-body">
		...
		{!! BootForm::openHorizontal($columnSizes)->action(route('admin::classes_mgmt::classes.store-repeat',$ahamClass->id)) !!}

		{!! BootForm::select('Topic *', 'topic_id')
					->options($topics)
					->attribute('required','true')
					->attribute('id','topic_id')
					->select($ahamClass->topic_id)
		!!}
        ...
        {!! BootForm::select('Grade', 'grades[]')
                      ...
                      ->placeholder('Grade')
                      ->select(explode(',', $ahamClass->grades)) !!}
		...
		<div class="col-sm-8 col-lg-10">
			...
			<label class="checkbox-inline">
				<input type="checkbox" class="styled" name="free" value="yes" {{ $ahamClass->free ? 'checked' : '' }}>
				This Class is Free
			</label>
		...
		<div class="col-sm-8 col-lg-10">
			...
			<label class="checkbox-inline">
				<input type="checkbox" class="styled" name="no_tutor_comp" value="yes" {{ $ahamClass->no_tutor_comp ? 'checked' : '' }}>
