...
$(document).ready(function(){
    ...
    table =  $('#myTable').DataTable({
		...
		"ajax": {
			...
			"type": "GET",
            "data": function (d) {
                var types = $('.toolbar #class_status option:selected').get().map(function(a, item){return a.value;})

                d['class_status'] = types;
            },
		},
		"columns": [
		    { "data": "classes.code", "name": "code" },
		    { "data": "classes.location_id", "name": "location_id" },
            { "data": "classes.topic_id", "name": "topic_id" },
            { "data": "classes.teacher", "name": "teacher_id" },
		    { "data": "classes.group_id", "name": "group_id" },
            { "data": "classes.status", "name": "status" },
            { "data": "classes.created_at", "name": "created_at"},
            { "data": "classes.creator_id", "name": "creator_id" },
		    { "data": "classes.scheduled", "name": "scheduled" },
		    { "data": "classes.free", "name": "free" },	    
		    { "data": "classes.start_date", "name": "start_date"},
		    { "data": "classes.enrollment_cutoff", "name": "enrollment_cutoff"},
