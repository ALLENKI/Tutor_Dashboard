...
<div class="page-header">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Users</span> - Coupons</h4>

			<ul class="breadcrumb breadcrumb-caret position-right">
				<li><a href="{{ route('admin::admin') }}">Home</a></li>
				<li><a href="{{ route('admin::users::coupons.index') }}">Coupons</a></li>
				<li class="active">Create New Coupon</li>
			</ul>
		</div>
	</div>
</div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Create a Coupon</h5>
	</div>
	...
	<div class="panel-body">
		...
		{!! BootForm::openHorizontal($columnSizes)->action(route('admin::users::coupons.store')) !!}

		{!! BootForm::text('Coupon', 'coupon')
                ->placeholder('Coupon')
		...
		{!! BootForm::text('Max Users', 'max_users_limit')
        ...
        <div class="form-group">
        	<label class="col-sm-4 col-lg-2 control-label" for="user_id">User</label>
        	...
        	<div class="col-sm-8 col-lg-6">
        		...
        		<span class="help-block">If you select a user, it is applied to only the selected user.<span>
        	</div>
        </div>
