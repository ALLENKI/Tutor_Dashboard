...
<div class="page-header">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Coupons</span></h4>
		...
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="{{ route('admin::users::coupons.create') }}" class="btn btn-link btn-float has-text"><i class="icon-plus2 text-primary"></i><span>Create New Coupon</span></a>
			</div>
		</div>
	</div>
</div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">List of Coupons</h5>
		<div class="heading-elements">
			<ul class="icons-list">
...
$(document).ready(function(){
    ...
    table =  $('#myTable').DataTable({
		...
		"columns": [
		    ...
		    { "data": "coupons.user_id", "name": "user_id"},  
		],
    });
