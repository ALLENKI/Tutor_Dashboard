		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<br>
					<br>
					Just hit "Reset Password" below or copy paste the following link in your browser window: <br>
					<strong>
						{{ $link }}
					</strong>
					<br>
