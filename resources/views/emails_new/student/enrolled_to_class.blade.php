...
<tbody><tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <td style="font-size: 13px; line-height: 25px; color:#7f8c8d; font-family: 'Open Sans', sans-serif;"> 
                    ...
                    Thanks for enrolling to the class below.

                    <br><br>

                    <span>This class will be in session if the minimum enrollment is met. Please check the course page if you want to check the latest enrollment status.</span>
                    <br><br>
        ...
        <table width="245" cellpadding="0" cellspacing="0" border="0" style="  display: block; background: #ff5722;text-align:center;  border-radius:2px;" align="center">
            <tbody><tr>
                <td width="245" height="40" style="font-size: 13px; color: #fffefe; font-family: 'Montserrat', sans-serif; text-transform: uppercase; text-align: center;text-decoration: none;font-weight: 700;  border-radius:2px;"><a href="{{ route('student::home') }}" style="color: #fffefe; line-height: 40px;  display: block;text-decoration: none;font-weight: 700; text-align:center; border-radius:2px; "> Go To My Dashboard</a></td>
            </tr>
        </tbody></table></td>
    </tr>
    <tr>
