			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td style="font-size: 13px; line-height: 25px; color:#7f8c8d; font-family: 'Open Sans', sans-serif;"> 
						<strong>The below mentioned class is now marked as complete. </strong>

						<br><br>
						 We hope you enjoyed the experience of taking the class. Your feedback is very important to us. Please go to your dashboard to provide <a href="{{ route('student::class.show', $class->code) }}">feedback</a> for the Tutor who took this class. 
