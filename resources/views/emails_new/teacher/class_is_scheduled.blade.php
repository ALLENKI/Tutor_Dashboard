...
<tbody><tr>
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    ...
                    <span>You can  start using class page to interact with your learners from now until 1 week after the class finishes.</span>
    ...
    <tr>
        ...
        <table width="245" cellpadding="0" cellspacing="0" border="0" style="  display: block; background: #ff5722;text-align:center;  border-radius:2px;" align="center">
            <tbody><tr>
                <td width="245" height="40" style="font-size: 13px; color: #fffefe; font-family: 'Montserrat', sans-serif; text-transform: uppercase; text-align: center;text-decoration: none;font-weight: 700;  border-radius:2px;"><a href="{{ route('teacher::class.show',$class->code) }}" style="color: #fffefe; line-height: 40px;  display: block;text-decoration: none;font-weight: 700; text-align:center; border-radius:2px; "> Go To Class Page</a></td>
            </tr>
        </tbody></table></td>
    </tr>
    <tr>
