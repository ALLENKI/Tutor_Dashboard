		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<td style="font-size: 13px; line-height: 25px; color:#7f8c8d; font-family: 'Open Sans', sans-serif;"> 
					...
					The below mentioned class that was scheduled earlier for you to teach is now <bold> CANCELLED </bold> for the following reason mentioned during cancellation: {{ $class->cancellation_reason }}.
