			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td style="font-size: 13px; line-height: 25px; color:#7f8c8d; font-family: 'Open Sans', sans-serif;"> 
						<strong>Congratulations! You are now a Tutor at Aham.  We are extremely excited to have you onboard.</strong>
						<br><br>
						We have marked "Topics you can Teach at Aham" under My Certification section in your <a href="{{ url('dashboard/teacher/certification') }}">Tutor Dashboard.</a> 
