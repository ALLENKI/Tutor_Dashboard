			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td style="font-size: 13px; line-height: 25px; color:#7f8c8d; font-family: 'Open Sans', sans-serif;"> 
						...
						Congratulations! You are now a Tutor at Aham. 
						<br><br>
						We are extremely excited to have you onboard. We have marked "Topics you can Teach at Aham"  under My Certification section in your <a href="{{ url('dashboard/teacher/certification') }}">tutor dashboard</a>.
	 
				<br><br>
				<strong>Tutor Dashboard is personalized for you, so you can focus more on teaching and less on the logistics. Please watch this video to learn what the dashboard has in store for you.</strong>
				<br><br>
