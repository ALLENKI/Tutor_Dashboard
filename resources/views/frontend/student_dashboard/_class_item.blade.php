...
<h3 class="title">
<a href="{{ url('classes-in-'.$ahamClass->topic->slug) }}">
...
<div class="row">
		...
		<div class="col-md-6">
			...
			<a href="{{ route('student_dashboard::class.enroll',$ahamClass->id) }}" class="rest btn-danger btn-extra-small" data-method="POST">Cancel Enrollment</a>
			@endif
