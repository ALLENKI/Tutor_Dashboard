    ...
    <section class="sub-banner sub-banner-course">
        ...
        <div class="container">
            <div class="sub-banner-content">
                <h2 class="text-center">Forces & Newton's Laws</h2>
            </div>
        </div>
    </section>
    <!-- END / SUB BANNER -->
                        ...
                        <div class="video-course-intro">
                            <div class="inner">
                                ...
                                <div class="video embed-responsive embed-responsive-16by9">
                                    ...
                                    <iframe width="420" height="300" src="https://www.youtube.com/embed/EGmzJe0TAts" frameborder="0" allowfullscreen></iframe>
                                </div>
                ...
                <div class="col-md-7">
                    <div class="tabs-page">
                        <ul class="nav-tabs" role="tablist">
                            ...
                            <li><a href="#outline" role="tab" data-toggle="tab">Class Notes</a></li>
                            <li><a href="#review" role="tab" data-toggle="tab">Review</a></li>
                            <li><a href="#student" role="tab" data-toggle="tab">Students</a></li>
                            <li><a href="#conment" role="tab" data-toggle="tab">Questionnaire</a></li>
                        </ul>
                        <!-- Tab panes -->
