                ...
                <div class="m-portlet__head-tools">
                  <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                      ...
                      <router-link v-if="dashboard" :to="{ name: 'edit-course', params: {course: course.id} }"  class="m-portlet__nav-link btn btn-success m-btn m-btn--pill m-btn--air">
                        Edit
                      </router-link>
        ...
        <div v-if="courseTree" class="col-md-6">
                <div class="m-section">
									<div class="m-section__content">
										<table v-if="course" class="table m-table m-table--head-separator-danger">
											<thead>
												<tr>
                           ...
                           <strong> Courses </strong>
											...
											<tbody>
												<tr  v-for="item in courseTree">
													...
													<td v-if="course.type == 'collection_of_topics'">
                            ...
                            <router-link :to="{name: 'view-topic', params: {topic: item.id}}">
                                {{item.name}}
													...
													<td v-if="course.type == 'collection_of_courses'">

                            <router-link @click="reload" :to="{name: 'view-course', params: {course: item.id}}">
                                {{item.name}}
                            </router-link>
