                    ...
                    <div class="col-md-6">
                        ...
                        <div class="m-portlet m-portlet--mobile">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <!--begin::m-widget4-->
                                    <div class="m-widget4">
                                        <div v-if="dataBaseCourseTree" v-for="item in dataBaseCourseTree" class="m-widget4__item">
                                ...
                                <!--begin::m-widget4-->
                                    <div class="m-widget4">
                                        <div v-if="LocalCatalogueTree" v-for="item in LocalCatalogueTree" class="m-widget4__item">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 v-if="editCourse" class="modal-title" id="exampleModalLabel">
                                Add 
                                <span v-if="editCourse.type == 'collection_of_topics'">
                                        <strong>  Topics </strong>
                                        </span> 
  ...
  methods: {
    ...
    getTree() {
        ...
        axios
            ...
            .then(response => {
                    this.dataBaseCourseTree = response.data;
            })
            .catch(error => {
            console.log(error);
            });
    ...
    getCatalogue() {
        ...
        axios.
            get(this.url = 'course_catalog/courses/get-'+this.type+'?id='+this.$route.params.course)
            .then(response => {
    ...
    removeAddTopics(id) {
        ...
        this.LocalCatalogueTree.forEach(item => {

            if( id === item.id) {
                this.LocalCatalogueTree.pop(item);
            }
    ...
    showItems() {
        ...
        vm.LocalCatalogueTree = [];

        vm.selectedItem.forEach(selectedId => {
            vm.catalogue.forEach(item => {

                if( selectedId === item.id ) {
                    vm.LocalCatalogueTree.push({'name': item.name,'id': item.id});
                }
