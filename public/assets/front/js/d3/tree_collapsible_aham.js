 ...
 * ---------------------------------------------------------------------------- */
    ...
    function treeCollapsible(element, height, studentgraphurl) {
        ...
        // Add SVG element
        var container = d3Container.append("svg").call(zoomListener);
        ...
        var tree = d3.layout.tree()
            ...
            .separation(function(a, b) {return ((a.parent.name == b.parent.name) ? 200 : 300); });
        ...
        d3.json(studentgraphurl, function(error, json) {
            ...
            function toggleAll(d) {
                if(typeof d.toggle != 'undefined'){
                    if (d.children && d.toggle) {
                        console.log('Toggle');
