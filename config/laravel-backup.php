...
return [
    ...
    'notifications' => [
         ...
         */
        'events' => [
            'whenBackupWasSuccessful'     => ['log',Aham\Services\Backup\HipchatSender::class],
            'whenCleanupWasSuccessful'    => ['log'],
            'whenHealthyBackupWasFound'   => ['log'],
            'whenBackupHasFailed'         => ['log', Aham\Services\Backup\HipchatSender::class, 'mail'],
